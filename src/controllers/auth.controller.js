...
const getCurrentUser = asyncHandler(async (req, res) => {
  return res
    .status(200)
    .json(new ApiResponse(200, req.user, "Cureent User fetch successfully"));
});
...
const resendEmailVerification = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, "Mail has been sent to you email id"));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        {},
        "password reset mail has been sent on you mail id",
      ),
    );
});
